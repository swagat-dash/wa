...
function File_Manager(){
    ...
    this.addFile = function(media, media_tmp, type){
		...
		var typesNotMedia= ['pdf', 'pptx', 'ppt', 'doc', 'docx', 'txt', 'rtf', 'xls', 'xlsx','csv', 'ogg', 'mp3'];
		
		if(typesNotMedia.includes(type.toLowerCase()) ){
			var html = '<div class="fm-item ui-state-default">';
                html+= '<img src="/assets/types/'+type.toUpperCase()+'.png"/>';
