...
<div class="container p-25">
        ...
        <div class="wa-list-message my-3">
            <form class="actionForm post-create p-t-10" action="<?php _e( get_module_url("simple_button_message_save/". get_data($result, "ids") ) )?>" data-call-after="WhatsappJs.reload_button_template(result);">
                <div class="card mb-4">
                    <div class="card-body">
                    ...
                    <div class="card-body p-0">
                        <ul class="list-group list-group-flush bg-soild-danger wa-lm-list-option">
                            ...
                            if( !empty($result) ){
                                ...
                                if( !empty($data) && isset($data->buttons) && count($data->buttons) != 0 ){
                            ...
                            <?php if(!empty($options)){?>
                                ...
                                <?php foreach ($options as $key => $value): 
                                    ...
                                    $displayText = $value->buttonText->displayText;
                                    $triggerText = $value->buttonId;
                                    $triggerTextLabel = '⚡ ';
                                        ...
                                        <div  class="col-12 col-sm-9 m-0 p-0">
                                            <div class="collapse" id="collapse-<?php _e( $key )?>">
                                                <div class="card card-body m-0 border-0">
                                                    ...
                                                    <nav class="mt-0">
                                                        <div class="nav nav-pills mr-5" id="nav-tab" role="tablist">
                                                            <label for="btn_type_text_<?php _e( $key )?>" data-key="<?php _e( $key )?>" class="nav-item nav-link radio-tab <?php _e( get_data($value, "quickReplyButton") != false || true?"active":"" ) ?>" data-toggle="tab" href="#nav_btn_type_text_<?php _e( $key )?>" role="tab">
                                                                <input class="d-none btn-type" type="radio" name="btn_msg_type[<?php _e( $key )?>]" id="btn_type_text_<?php _e( $key )?>" <?php _e( get_data($value, "quickReplyButton") != false || true?'checked="true"':"" ) ?> value="1">
                                                    ...
                                                    <div class="tab-content pt-3" id="nav-tabContent">
                                                        ...
                                                        <div class="tab-pane fade <?php _e( get_data($value, "quickReplyButton") != false || true?"show active":"" ) ?>" id="nav_btn_type_text_<?php _e( $key )?>" role="tabpanel">
                                                            <div class="post">
                                                                <div class="post-content">
                                                                    <div class="form-group">
