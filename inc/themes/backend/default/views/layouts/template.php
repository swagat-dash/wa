...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php _e( get_theme_backend_url('assets/plugins/bootstrap/css/bootstrap.css') )?>">
	...
	<link rel="stylesheet" type="text/css" href="<?php _e( get_theme_backend_url('assets/css/skin-simplemax.css') )?>">
		...
		<div class="menu sidebar-hover">
			...
			<div class="menu-item">
				<a href="#" target="_blank">
					<span class="menu-icon"><i class="far fa-life-ring"></i></span>
					<span class="menu-desc">Custom Menu</span>
				</a>
			</div>
			-->
...
<?php } ?>
    ...
    <script type="module" src="<?php _e( base_url("assets/additional.js"), false)?>"></script>
    
    <script type="module" src="<?php _e( get_theme_backend_url("assets/js/skin-simplemax.js"), false)?>"></script>
