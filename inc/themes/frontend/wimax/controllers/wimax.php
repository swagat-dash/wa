...
class wimax extends MY_Controller {
	...
	public function calling_code(){
		$timezone = post("calling_code");
		_ss("calling_code", $timezone);
		ms(["calling_code" => $timezone]);
	}
	...
	public function ajax_signup()
	{
		...
		$this->user_manager_model->signup($fullname, $email, $password, $confirm_password, $timezone, $terms, $code, $number, $opt_verified);
	}
